  ...
  return (
    <div className="flex min-w-full h-screen">
      ...
      <Sidebar className='flex justify-between content-between flex-row space-5'>
        <div className="">
          ...
          <div className="mt-4">
            <button 
              ...
              className="w-full text-left px-4 py-2 text-gray-300 hover:bg-gray-800 rounded"
            >
              Logout
            </button>
          </div>
        ...
        <div>
          {/* User profile info could go here if needed */}
        </div>
      </Sidebar> 
      
      {/* The ChatContainer component now handles fetching and sending messages */}
      <ChatContainer />
    </div>
  );
}